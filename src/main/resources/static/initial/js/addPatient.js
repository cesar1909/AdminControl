...
//----------Controls----------//
const btntoinitialConsultation = $('#btntoinitialConsultation');
const btnbacktoregister = $('#btnbacktoregister');
...
const tab3IC = $('#tab3IC');
    ...
    //Boton prueba para pasar de agregar paciente a consulta inicial


    btntoinitialConsultation.click(()=>{
        let valid=true;
    // $.each(formValidate, (key, value)=>{
    //     if(value!=true)valid=false;
    // } );
