...
//		System.out.println("EMAIL:: "+this.userServiceImpl.getEmailUser());
		...
		String input ="Alfredo";
		List<FindFullNameByEmailResult> list = fullname.stream().filter(x -> x.getNombre().contains(input.toLowerCase())).collect(Collectors.toList());
		
		for(FindFullNameByEmailResult item : list){
