        ...
        try{
            ...
            for (int i = 0; allPatients.size() > i; i++) {
                ...
                try {
                    ...
                    row.createCell(147).setCellValue(monthlyConsultations.get(0).getToxNeuroatiaPerif());
                    row.createCell(148).setCellValue(monthlyConsultations.get(3).getToxInfectious());
                    row.createCell(149).setCellValue(monthlyConsultations.get(3).getInfectionSite());
                    row.createCell(150).setCellValue(monthlyConsultations.get(3).getInfusionMedReaction());
                    row.createCell(151).setCellValue(monthlyConsultations.get(3).getAdverseReaction());

                    //Quinta consulta mensual
                    row.createCell(152).setCellValue(monthlyConsultations.get(4).getTreatmentCycleNum());
                    row.createCell(153).setCellValue(monthlyConsultations.get(4).getDateOfRealization());
                    row.createCell(154).setCellValue(monthlyConsultations.get(4).getAlbumin());
                    row.createCell(155).setCellValue(monthlyConsultations.get(4).getSerumCalcium());
                    row.createCell(156).setCellValue(monthlyConsultations.get(4).getLacticDehydrogenase());
                    row.createCell(157).setCellValue(monthlyConsultations.get(4).getHemoglobin());
                    row.createCell(158).setCellValue(monthlyConsultations.get(4).getHematocrit());
                    row.createCell(159).setCellValue(monthlyConsultations.get(4).getLeukocytes());
                    row.createCell(160).setCellValue(monthlyConsultations.get(4).getLymphocytes());
                    row.createCell(161).setCellValue(monthlyConsultations.get(4).getNeutrophils());
                    row.createCell(162).setCellValue(monthlyConsultations.get(4).getPlatelets());
                    row.createCell(163).setCellValue(monthlyConsultations.get(4).getIgG());
                    row.createCell(164).setCellValue(monthlyConsultations.get(4).getIgA());
                    row.createCell(165).setCellValue(monthlyConsultations.get(4).getIgM());
                    row.createCell(166).setCellValue(monthlyConsultations.get(4).getLightChainsKappa());
                    row.createCell(167).setCellValue(monthlyConsultations.get(4).getLightChainsLambda());
                    row.createCell(168).setCellValue(monthlyConsultations.get(4).getToxHemtoRedSerie());
                    row.createCell(169).setCellValue(monthlyConsultations.get(4).getToxHemtoNeutrophils());
                    row.createCell(170).setCellValue(monthlyConsultations.get(4).getToxHemtoPlatelets());
                    row.createCell(171).setCellValue(monthlyConsultations.get(4).getToxHepatics());
                    row.createCell(172).setCellValue(monthlyConsultations.get(4).getToxRenal());
                    row.createCell(173).setCellValue(monthlyConsultations.get(4).getToxGastroNausea());
                    row.createCell(174).setCellValue(monthlyConsultations.get(4).getToxGastroDiarrhea());
                    row.createCell(175).setCellValue(monthlyConsultations.get(0).getToxNeuroatiaPerif());
                    row.createCell(176).setCellValue(monthlyConsultations.get(4).getToxInfectious());
                    row.createCell(177).setCellValue(monthlyConsultations.get(4).getInfectionSite());
                    row.createCell(178).setCellValue(monthlyConsultations.get(4).getInfusionMedReaction());
                    row.createCell(179).setCellValue(monthlyConsultations.get(4).getAdverseReaction());

                    //Sexta consulta mensual
                    row.createCell(180).setCellValue(monthlyConsultations.get(5).getTreatmentCycleNum());
                    row.createCell(181).setCellValue(monthlyConsultations.get(5).getDateOfRealization());
                    row.createCell(182).setCellValue(monthlyConsultations.get(5).getAlbumin());
                    row.createCell(183).setCellValue(monthlyConsultations.get(5).getSerumCalcium());
                    row.createCell(184).setCellValue(monthlyConsultations.get(5).getLacticDehydrogenase());
                    row.createCell(185).setCellValue(monthlyConsultations.get(5).getHemoglobin());
                    row.createCell(186).setCellValue(monthlyConsultations.get(5).getHematocrit());
                    row.createCell(187).setCellValue(monthlyConsultations.get(5).getLeukocytes());
                    row.createCell(188).setCellValue(monthlyConsultations.get(5).getLymphocytes());
                    row.createCell(189).setCellValue(monthlyConsultations.get(5).getNeutrophils());
                    row.createCell(190).setCellValue(monthlyConsultations.get(5).getPlatelets());
                    row.createCell(191).setCellValue(monthlyConsultations.get(5).getIgG());
                    row.createCell(192).setCellValue(monthlyConsultations.get(5).getIgA());
                    row.createCell(193).setCellValue(monthlyConsultations.get(5).getIgM());
                    row.createCell(194).setCellValue(monthlyConsultations.get(5).getLightChainsKappa());
                    row.createCell(195).setCellValue(monthlyConsultations.get(5).getLightChainsLambda());
                    row.createCell(196).setCellValue(monthlyConsultations.get(5).getToxHemtoRedSerie());
                    row.createCell(197).setCellValue(monthlyConsultations.get(5).getToxHemtoNeutrophils());
                    row.createCell(198).setCellValue(monthlyConsultations.get(5).getToxHemtoPlatelets());
                    row.createCell(199).setCellValue(monthlyConsultations.get(5).getToxHepatics());
                    row.createCell(200).setCellValue(monthlyConsultations.get(5).getToxRenal());
                    row.createCell(201).setCellValue(monthlyConsultations.get(5).getToxGastroNausea());
                    row.createCell(202).setCellValue(monthlyConsultations.get(5).getToxGastroDiarrhea());
                    row.createCell(203).setCellValue(monthlyConsultations.get(0).getToxNeuroatiaPerif());
                    row.createCell(204).setCellValue(monthlyConsultations.get(5).getToxInfectious());
                    row.createCell(205).setCellValue(monthlyConsultations.get(5).getInfectionSite());
                    row.createCell(206).setCellValue(monthlyConsultations.get(5).getInfusionMedReaction());
                    row.createCell(207).setCellValue(monthlyConsultations.get(5).getAdverseReaction());

                    //Septima consulta mensual
                    row.createCell(208).setCellValue(monthlyConsultations.get(6).getTreatmentCycleNum());
                    row.createCell(209).setCellValue(monthlyConsultations.get(6).getDateOfRealization());
                    row.createCell(210).setCellValue(monthlyConsultations.get(6).getAlbumin());
                    row.createCell(211).setCellValue(monthlyConsultations.get(6).getSerumCalcium());
                    row.createCell(212).setCellValue(monthlyConsultations.get(6).getLacticDehydrogenase());
                    row.createCell(213).setCellValue(monthlyConsultations.get(6).getHemoglobin());
                    row.createCell(214).setCellValue(monthlyConsultations.get(6).getHematocrit());
                    row.createCell(215).setCellValue(monthlyConsultations.get(6).getLeukocytes());
                    row.createCell(216).setCellValue(monthlyConsultations.get(6).getLymphocytes());
                    row.createCell(217).setCellValue(monthlyConsultations.get(6).getNeutrophils());
                    row.createCell(218).setCellValue(monthlyConsultations.get(6).getPlatelets());
                    row.createCell(219).setCellValue(monthlyConsultations.get(6).getIgG());
                    row.createCell(220).setCellValue(monthlyConsultations.get(6).getIgA());
                    row.createCell(221).setCellValue(monthlyConsultations.get(6).getIgM());
                    row.createCell(222).setCellValue(monthlyConsultations.get(6).getLightChainsKappa());
                    row.createCell(223).setCellValue(monthlyConsultations.get(6).getLightChainsLambda());
                    row.createCell(224).setCellValue(monthlyConsultations.get(6).getToxHemtoRedSerie());
                    row.createCell(225).setCellValue(monthlyConsultations.get(6).getToxHemtoNeutrophils());
                    row.createCell(226).setCellValue(monthlyConsultations.get(6).getToxHemtoPlatelets());
                    row.createCell(227).setCellValue(monthlyConsultations.get(6).getToxHepatics());
                    row.createCell(228).setCellValue(monthlyConsultations.get(6).getToxRenal());
                    row.createCell(229).setCellValue(monthlyConsultations.get(6).getToxGastroNausea());
                    row.createCell(230).setCellValue(monthlyConsultations.get(6).getToxGastroDiarrhea());
                    row.createCell(231).setCellValue(monthlyConsultations.get(0).getToxNeuroatiaPerif());
                    row.createCell(232).setCellValue(monthlyConsultations.get(6).getToxInfectious());
                    row.createCell(233).setCellValue(monthlyConsultations.get(6).getInfectionSite());
                    row.createCell(234).setCellValue(monthlyConsultations.get(6).getInfusionMedReaction());
                    row.createCell(235).setCellValue(monthlyConsultations.get(6).getAdverseReaction());

                    //Octava consulta mensual
                    row.createCell(236).setCellValue(monthlyConsultations.get(7).getTreatmentCycleNum());
                    row.createCell(237).setCellValue(monthlyConsultations.get(7).getDateOfRealization());
                    row.createCell(238).setCellValue(monthlyConsultations.get(7).getAlbumin());
                    row.createCell(239).setCellValue(monthlyConsultations.get(7).getSerumCalcium());
                    row.createCell(240).setCellValue(monthlyConsultations.get(7).getLacticDehydrogenase());
                    row.createCell(241).setCellValue(monthlyConsultations.get(7).getHemoglobin());
                    row.createCell(242).setCellValue(monthlyConsultations.get(7).getHematocrit());
                    row.createCell(243).setCellValue(monthlyConsultations.get(7).getLeukocytes());
                    row.createCell(244).setCellValue(monthlyConsultations.get(7).getLymphocytes());
                    row.createCell(245).setCellValue(monthlyConsultations.get(7).getNeutrophils());
                    row.createCell(246).setCellValue(monthlyConsultations.get(7).getPlatelets());
                    row.createCell(247).setCellValue(monthlyConsultations.get(7).getIgG());
                    row.createCell(248).setCellValue(monthlyConsultations.get(7).getIgA());
                    row.createCell(249).setCellValue(monthlyConsultations.get(7).getIgM());
                    row.createCell(250).setCellValue(monthlyConsultations.get(7).getLightChainsKappa());
                    row.createCell(251).setCellValue(monthlyConsultations.get(7).getLightChainsLambda());
                    row.createCell(252).setCellValue(monthlyConsultations.get(7).getToxHemtoRedSerie());
                    row.createCell(253).setCellValue(monthlyConsultations.get(7).getToxHemtoNeutrophils());
                    row.createCell(254).setCellValue(monthlyConsultations.get(7).getToxHemtoPlatelets());
                    row.createCell(255).setCellValue(monthlyConsultations.get(7).getToxHepatics());
                    row.createCell(256).setCellValue(monthlyConsultations.get(7).getToxRenal());
                    row.createCell(257).setCellValue(monthlyConsultations.get(7).getToxGastroNausea());
                    row.createCell(258).setCellValue(monthlyConsultations.get(7).getToxGastroDiarrhea());
                    row.createCell(259).setCellValue(monthlyConsultations.get(0).getToxNeuroatiaPerif());
                    row.createCell(250).setCellValue(monthlyConsultations.get(7).getToxInfectious());
                    row.createCell(261).setCellValue(monthlyConsultations.get(7).getInfectionSite());
                    row.createCell(262).setCellValue(monthlyConsultations.get(7).getInfusionMedReaction());
                    row.createCell(263).setCellValue(monthlyConsultations.get(7).getAdverseReaction());
                ...
                try {
                    if (finalConsultation != null){
                        ...
                        row.createCell(264).setCellValue(finalConsultation.getDateOfRealization());
                        row.createCell(265).setCellValue(finalConsultation.getAlbumin());
                        row.createCell(266).setCellValue(finalConsultation.getSerumCalcium());
                        row.createCell(267).setCellValue(finalConsultation.getLacticDehydrogenase());
                        row.createCell(268).setCellValue(finalConsultation.getHemoglobin());
                        row.createCell(269).setCellValue(finalConsultation.getHematocrit());
                        row.createCell(270).setCellValue(finalConsultation.getLeukocytes());
                        row.createCell(271).setCellValue(finalConsultation.getLymphocytes());
                        row.createCell(272).setCellValue(finalConsultation.getNeutrophils());
                        row.createCell(273).setCellValue(finalConsultation.getPlatelets());
                        row.createCell(274).setCellValue(finalConsultation.getIgG());
                        row.createCell(275).setCellValue(finalConsultation.getIgA());
                        row.createCell(276).setCellValue(finalConsultation.getIgM());
                        row.createCell(277).setCellValue(finalConsultation.getLightChainsKappa());
                        row.createCell(278).setCellValue(finalConsultation.getLightChainsLambda());
                        row.createCell(279).setCellValue(finalConsultation.getCelPlasmaticEnMedulaOsea());
                        row.createCell(280).setCellValue(finalConsultation.getElectroForesisDeProteinasSuero());
                        row.createCell(281).setCellValue(finalConsultation.getElectroForesisDeProteinasOrina());
                        row.createCell(282).setCellValue(finalConsultation.getInmFijacionTipoIg());
                        row.createCell(283).setCellValue(finalConsultation.getInmFijacionTipoCll());
                        row.createCell(284).setCellValue(finalConsultation.getEnfermedadMinimaResidual());
                        row.createCell(285).setCellValue(finalConsultation.getRepuestaATratamiento());
                        row.createCell(286).setCellValue(finalConsultation.getComentariosExtrax());
                        row.createCell(287).setCellValue(finalConsultation.getDateOfTransplant());
                        row.createCell(288).setCellValue(finalConsultation.getNumberOfCD34Infused());
                        row.createCell(289).setCellValue(finalConsultation.getMyeloidGraftDate());
                        row.createCell(290).setCellValue(finalConsultation.getDatePlateletGraft());
                        row.createCell(291).setCellValue(finalConsultation.getToxHemtoRedSerie());
                        row.createCell(292).setCellValue(finalConsultation.getToxHemtoNeutrophils());
                        row.createCell(293).setCellValue(finalConsultation.getToxHemtoPlatelets());
                        row.createCell(294).setCellValue(finalConsultation.getToxHepatics());
                        row.createCell(295).setCellValue(finalConsultation.getToxRenal());
                        row.createCell(296).setCellValue(finalConsultation.getToxGastroNausea());
                        row.createCell(297).setCellValue(finalConsultation.getToxGastroDiarrhea());
                        row.createCell(298).setCellValue(finalConsultation.getToxNeuroatiaPerif());
                        row.createCell(299).setCellValue(finalConsultation.getToxInfectious());
                    }
                    else {
